...
.global subBytes
subBytes:                            // Parametros x0 -> Matriz a Convertir, x1 -> Cuantos Bytes Se Convertiran
    STP x29, x30, [SP, #-16]!

    LDR x3, =Sbox                    // Cargar la direccion de la S-Box
    MOV x6, x0                       // Cargar la direccion de la matriz de estado
    MOV x7, x1                       // Inicializar el contador de recorrido de la matriz de estado
    ...
    recorrido_bytes:
        ...
        CBNZ recorrido_bytes         // Si no se recorrieron todas las celdas, repetir el proceso
